...
```{r selectivity_ratio_plot, fig.width=7, fig.height=4.5, fig.cap="Figure 3: Childcare Gaps Exceed Adult Care Gaps Across All Subgroups"}
...
```{r care_comparison_plot, fig.width=8, fig.height=5, fig.cap="Figure 1: Gender Disparities in Care Work Time by Type"}
...
```{r participation_plot, fig.width=8, fig.height=5, fig.cap="Figure 2: Gender Gaps in Care Work Participation by Type"}
