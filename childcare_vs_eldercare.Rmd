...
**Household Structure Unobserved**: We lack data on household composition (number of children, presence of elderly members, co-residence patterns). Gender gaps in care participation partly reflect differential care needs—households without young children show zero childcare by definition. We cannot distinguish "men avoid care when needed" from "men live in households without care demands." Ideally, analyses would condition on presence of care recipients, but such data are unavailable.
